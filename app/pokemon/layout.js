...
{
      window.location.pathname === '/pokemon/home' ? (
        <span class="w-1 h-1 bg-teal-700 dark:bg-yellow-500 absolute rounded-full left-1/2 -translate-x-1/2" />
      ) : null
    }
                </div>
...
{
      window.location.pathname === '/pokemon/profile' ? (
        <span class="w-1 h-1 bg-teal-700 dark:bg-yellow-500 absolute rounded-full left-1/2 -translate-x-1/2" />
      ) : null
    }
                </div>
        ...
        {
      window.location.pathname === '/pokemon/cart' ? (
        <span class="w-1 h-1 bg-teal-700 dark:bg-yellow-500 absolute rounded-full left-1/2 -translate-x-1/2" />
      ) : null
    }
        </div>
